    ...
    const fetchProject = async () => {
        ...
        if (data) {
            setFormData({
                ...
                price: data.billed_amount?.toString() || "",
                default_price: data.default_price?.toString() || "",
                default_editor_price: data.default_editor_price?.toString() || "",
                status: data.status || "pending",
                currency: data.currency || "ARS",
                payment_method_in: data.payment_method_in || "",
                payment_method_out: data.payment_method_out || "",
            })
        }
    }
